...
const Bfake = fs.readFileSync ('./media/image/fake.jpeg','base64')
 ...
 let d = new Date
     ...
     let weton = ['Pahing', 'Pon','Wage','Kliwon','Legi'][Math.floor(((d * 1) + gmt) / 84600000) % 5]
        ...
        const katalog = (teks) => {
        res = farid.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 777, "message": teks, "footerText": "*_©Farz_*", "thumbnail": fakeimage, "surface": 'CATALOG' }}, {quoted:fgc})
...
//===============FAKE REPLY FARID====================
const floc = {
                  key:{ fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) },message: { "locationMessage": { "name": `${ucapanWaktu} \n⚖FARID GANS`, 'jpegThumbnail': fakeimage}}}
const floc1 = {
...
const floc2 = {
                  key: {"fromMe": false,"participant": `0@s.whatsapp.net`, "remoteJid": "6289530863358-1621036495@g.us" },message: { "liveLocationMessage": { "title":`Adventure`,}}}
const fgiv = {
...
//=========================FAKE REPLY======================
    ...
    if (prefix && command) cmdadd();
       ...
       farid.sendMessage(from,(`*「 LEVEL UP 」*\n\n➸ *Nama :* ${pushname}\n➸ *Xp :* ${level.getLevelingXp(sender, _level)} / ${fetchXp}\n➸ *Level :* ${currentLevel} -> ${level.getLevelingLevel(sender, _level)} 🆙 \n➸ *Role*: *${role}*\n\nCongrats!! 🎉🎉`), MessageType. text, {quoted: fgc, contextInfo: { mentionedJid: [sender],externalAdReply: { "title": `${ucapanWaktu} Kak ${pushname}👋🏻`, mediaType: 2, "thumbnailUrl": `https://telegra.ph/file/295700dec848810d6b777.jpg`, "mediaUrl": `https://youtu.be/E4_s-UlA7BEh`}}})
} 
       } catch (err) {
       console.error(err)
}
...
"contacts": ini_list 
}, 'contactsArrayMessage', { quoted: fgiv})
...
break
        ...
        case 'help':
             groups = farid.chats.array.filter(v => v.jid.endsWith('g.us'))
              ...
              has = await getBuffer(randKey.result)   
...
`        
farid.sendMessage(from, { contentText: `${menu}`, footerText: '© 𝆑ₐᵣ₋𝆎 流何・', buttons: [{ buttonId: `${prefix}command`, buttonText: { displayText: ' ⋮☰ COMMAND' }, type: 1 },{ buttonId: `${prefix}botstat`, buttonText: { displayText: '✓ INFO BOT' }, type: 1 } ], headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: has, contextInfo: {mentionedJid: [sender,far]}}}, 'buttonsMessage')
              break
...
randIndex = Math.floor(Math.random() * jsonAnu.length);
randKey = jsonAnu[randIndex];
gam = await getBuffer(randKey.result)   
far = '6285692949920@s.whatsapp.net'            
menu = ` 𝆑ₐᵣ₋𝆎 流何・             ✘✘✘
...
buttons = [
       ...
       case 'command':       
               ...
               listmsg(from, `${ucapanWaktu} ,`,`Pilih Menu Bot Disini`, list)
               break
...
──────────────────── 
`
farid.sendMessage(from, { contentText: `${menu}`, footerText: '© 𝆑ₐᵣ₋𝆎 流何・', buttons: [{ buttonId: `!owner`, buttonText: { displayText: 'OWNER' }, type: 1 },{ buttonId: `!infoig`, buttonText: { displayText: 'INSTAGRAM' }, type: 1 } ], headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: gambar, contextInfo: {mentionedJid: [sender]}}}, 'buttonsMessage')
              break
...
case 'tes':
case 'status':
        farid.sendMessage(from, `✓ *STATUS :* _${offline ? 'OFFLINE' : 'ONLINE'}_\n✓ *MODE :* ${public ? "_PUBLIC-MODE_" : "_SELF-MODE_"}\n✓ *ACTIVE :* _${runtime(process.uptime())}_`, text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": `Hi Kak ${pushname}\n${ucapanWaktu}\n${time2}`,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://telegra.ph/file/d2537c6c72c80526edbdb.jpg`,"thumbnail": "","sourceUrl": ""}}, quoted:fgc,quoted: fgif})
               break
    case 'infoig':
...
totalChat = await farid.chats.all()             
total = math(`${groups.length}*${privat.length}`)
vad =`• *Group Chats :* ${groups.length}
• *Private Chats :* ${privat.length}
• *Total Chats :* ${totalChat.length}
`
farid.sendMessage(from,vad , text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": `Hi Kak ${pushname}\n${ucapanWaktu}\n${time2}`,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://telegra.ph/file/d2537c6c72c80526edbdb.jpg`,"thumbnail": "","sourceUrl": ""}}, quoted:fgc,quoted: fgc})
             break 
case 'bucinstick':
                case 'bucinsticker':{
...
case 'bc1':
      ...
      if (!mek.key.fromMe && !isOwner) return farid.sendMessage(from,(mess.only.owner), MessageType. text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": ` ${ucapanWaktu}\n ${time2} WIB `,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://telegra.ph/file/dddc089c85c8a74b8966a.jpg`,"thumbnail": "","sourceUrl": ""}}, quoted: fgc})             
             ...
             farid.sendMesaage(from,('Suksess broadcast'), MessageType. text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": ` ${ucapanWaktu}\n ${time2} WIB `,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://telegra.ph/file/dddc089c85c8a74b8966a.jpg`,"thumbnail": "","sourceUrl": ""}}, quoted: fgc})
}
             break
case 'bc2':
      case 'broadcast2':
      if (!mek.key.fromMe && !isOwner) return farid.sendMessage(from,(mess.only.owner), MessageType. text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": ` ${ucapanWaktu}\n ${time2} WIB `,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://telegra.ph/file/dddc089c85c8a74b8966a.jpg`,"thumbnail": "","sourceUrl": ""}}, quoted: fgc})
            if (args.length < 1) return reply('teks?')
             ...
             farid.sendMessage(from,('Suksess broadcast'), MessageType. text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": ` ${ucapanWaktu}\n ${time2} WIB `,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://telegra.ph/file/dddc089c85c8a74b8966a.jpg`,"thumbnail": "","sourceUrl": ""}}, quoted: fgc})
}
             break
case 'well':
        if (!mek.key.fromMe && !isOwner) return farid.sendMessage(from,(mess.only.owner), MessageType. text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": ` ${ucapanWaktu}\n ${time2} WIB `,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://telegra.ph/file/d2537c6c72c80526edbdb.jpg`,"thumbnail": "","sourceUrl": ""}}, quoted: fgc})
...
buff = await getBuffer(profil)
              buttons = [
					{ buttonId: `${prefix}1`, buttonText: { displayText: 'Thanks🐣' }, type: 1 }, 
				]
				buttons = {
					locationMessage: {
						degressLongitude: 0,
...
case 'fitnah':
        ...
        case 'balance': 
               ...
               farid.sendMessage(from,(`Limit Game : ${cekGLimit(sender, gcount, glimit)}/${gcount}\nBalance : Rp.${balance}`), MessageType. text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": ` ${ucapanWaktu}\n ${time2} WIB `,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://telegra.ph/file/dddc089c85c8a74b8966a.jpg`,"thumbnail": "","sourceUrl": ""}}, quoted: fgc})
               break
         case 'gelud':
...
Ket : Ketik /resetgame , Untuk Mereset Permainan Yg Ada Di Grup!`, text, {contextInfo: {mentionedJid: [player2]}})
      ...
      //case 'tebakjenaka':
       ...
       case 'suit': //nyolong dari zenz
              ...
              const userspilih = q
              if (!userspilih.match(/batu|gunting|kertas/)) return sendFakeStatus(from,`Pilih batu, kertas, gunting`)
              ...
              sendFakeStatus(from,`Pertandingan Seri!`)
              } else if ( userspilih == 'batu' ) {
              if( computer == 'gunting' ) {
              sendFakeStatus(from,`Kamu memilih Batu dan bot Gunting\nKamu menang!`)
              } else {
              sendFakeStatus(from,`Kamu memilih Batu dan bot memilih Kertas\nKamu kalah!`)
}
              } else if ( userspilih == 'gunting' ) {
              if( computer == 'batu' ) {
              sendFakeStatus(from,`Kamu memilih Gunting dan bot memilih Batu\nKamu kalah!`)
              } else {
              sendFakeStatus(from,`Kamu memilih Gunting dan bot Kertas\nKamu menang!`)
}
              } else if ( userspilih == 'kertas' ) {
              if( computer == 'batu' ) {
              sendFakeStatus(from,`Kamu memilih Kertas dan bot Batu\nKamu menang!`)
              } else {
              sendFakeStatus(from,`Kamu memilih Kertas dan bot memilih Gunting\nKamu kalah`)
}
}
              break
//------------------< Sewa >-------------------
...
banc.splice(anu, 1)
fs.writeFileSync('./database/bc.json', JSON.stringify(banc, null, 2))
farid.sendMessage(from,(`Success Unbanchat In Group :\n✓ *${groupName}*`), MessageType. text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": ` ${ucapanWaktu}\n ${time2} WIB `,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://telegra.ph/file/d2537c6c72c80526edbdb.jpg`,"thumbnail": "","sourceUrl": ""}}, quoted: fgc})
}
break
case 'clearmessage':
case 'clearall':
